...
#import <PortmoneSDK/PortmoneSDK.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PortmoneSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// PortmoneWebView
SWIFT_CLASS("_TtC11PortmoneSDK15PortmoneWebView")
@interface PortmoneWebView : UIView <UIWebViewDelegate, WKNavigationDelegate>
